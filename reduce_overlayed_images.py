...
def main():
    ...
    parser.add_argument(
        "--src",
        type=str,
        default="overlayed_images",
        help="Source folder (default: overlayed_images)",
    )
    parser.add_argument(
        "--dst",
        type=str,
        default="overlayed_images_reduced",
        help="Destination folder (default: overlayed_images_reduced)",
    )
